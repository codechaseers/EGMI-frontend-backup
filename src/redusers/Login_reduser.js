...
//actions
  export const Loginuserinput= createAsyncThunk("userdata", async ({ mob_no},{ rejectWithValue })=>{
    const config={headers:{"Content-Type":"application/json"}}
    
     try {
      const data=await axios.get(`http://13.233.146.171:3010/user/userexist/${mob_no}` )  
      // const userdata=data
     // console.log( data );
      return data.data
     } catch (error) {
