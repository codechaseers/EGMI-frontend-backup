        ...
        >
          <div className="mydiv">
            <Link
              to={`/wireless-earbuds/?&heading=${encodeURIComponent(
               "Apple"
              )}&offer=${encodeURIComponent( JSON.stringify({"brand":"Apple"}))}`}
            >
              <img src={apple} />
              <p>Apple</p>
            </Link>
          ...
          <div className="mydiv">
            <Link to={`/wireless-earbuds/?&heading=${encodeURIComponent(
               "Boat"
              )}&offer=${encodeURIComponent( JSON.stringify({"brand":"Boat"}))}`}>
              <img src={boat} />
              <p>Boat</p>
            </Link>
          </div>
          <div className="mydiv">
            <Link to={`/wireless-earbuds/?&heading=${encodeURIComponent(
               "Fire Boalt"
              )}&offer=${encodeURIComponent( JSON.stringify({"brand":"Fire Boalt"}))}`}>
              <img src={fireBoltt} />
              <p>Fire Boalt</p>
            </Link>
          </div>
          <div className="mydiv">
            <Link to={`/wireless-earbuds/?&heading=${encodeURIComponent(
               "Mi"
              )}&offer=${encodeURIComponent( JSON.stringify({"brand":"Mi"}))}`}>
              <img src={mi} />
              <p>Mi</p>
            </Link>
          </div>
          <div className="mydiv">
            <Link to={`/wireless-earbuds/?&heading=${encodeURIComponent(
               "Noise"
              )}&offer=${encodeURIComponent( JSON.stringify({"brand":"Noise"}))}`}>
              <img src={noise} />
              <p>Noise</p>
            </Link>
          </div>
          <div className="mydiv">
            <Link to={`/wireless-earbuds/?&heading=${encodeURIComponent(
               "Oppo"
              )}&offer=${encodeURIComponent( JSON.stringify({"brand":"Oppo"}))}`}>
              <img src={oppo} />
              <p>Oppo</p>
            </Link>
          </div>
          <div className="mydiv">
            <Link to={`/wireless-earbuds/?&heading=${encodeURIComponent(
               "Realme"
              )}&offer=${encodeURIComponent( JSON.stringify({"brand":"Realme"}))}`}>
              <img src={realme} />
              <p>Realme</p>
            </Link>
          </div>
          <div className="mydiv">
            <Link to={`/wireless-earbuds/?&heading=${encodeURIComponent(
               "Samsung"
              )}&offer=${encodeURIComponent( JSON.stringify({"brand":"Samsung"}))}`}>
              <img src={samsung} />
              <p>Samsung</p>
            </Link>
          </div>
          <div className="mydiv">
            <Link to={`/wireless-earbuds/?&heading=${encodeURIComponent(
               "Vivo"
              )}&offer=${encodeURIComponent( JSON.stringify({"brand":"Vivo"}))}`}>
              <img src={vivo} />
              <p>Vivo</p>
            </Link>
          </div>
