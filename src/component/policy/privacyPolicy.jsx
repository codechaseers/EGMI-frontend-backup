      ...
      <div className="open_policy">
          ...
          <ul className="open_policy_list">
            <li>
              <Link to="/terms-and-conditions">
                Terms And Conditions <i class="fa fa-angle-right"></i>
              </Link>
            </li>
            <li>
              <Link to="/refund-policy">
                Refund Policy <i class="fa fa-angle-right"></i>
              </Link>
            </li>
            <li>
            ...
            {/* <li>
              <Link to="/return-policy">
                Return Policy <i class="fa fa-angle-right"></i>
              </Link>
            </li> */}
          </ul>
        </div>
        <div className="open_policy_right">
          ...
          <ul>
            ...
            <li>
              <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to EGMI</p>
            </li>
            <li>
              <p><strong>Cookies</strong> are small files that are placed on Your computer, mobile device or any other device by a website, containing the details of Your browsing history on that website among its many uses.</p>
            </li>
            <li>
              <p><strong>Country</strong> refers to: Patna,  India</p>
            </li>
            <li>
            ...
            <li>
              <p><strong>Website</strong> refers to EGMI, accessible from <a href="https://egmi.in/" rel="external nofollow noopener" target="_blank">https://egmi.in/</a></p>
            </li>
            <li>
          ...
          <ul>
            <li>By email:egmi7777@gmail.com</li>
          </ul>
        </div>
      </div>
    </>
